...
const supportedMajorVersion = 'v14'; // NODE_VERSION
...
if (majorVersion !== supportedMajorVersion) {
  ...
  console.log(`Layer0${cliVersion} supports only Node.js ${supportedMajorVersion} but your current version is ${process.version}.`);
...
const child = spawn('node', ['--max-http-header-size=65536', join(__dirname, 'cli-local.js')].concat(args), {
  stdio: 'inherit'
