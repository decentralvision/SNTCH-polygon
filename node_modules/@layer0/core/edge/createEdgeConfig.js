 ...
 * @private
 */
function buildRouteActionFromEdgeWriter({ edgeConfig }) {
...
async function createDestinationMapFunction(route, writer, faultyRoutes) {
    try {
        // @ts-ignore
...
async function createDestination(router) {
    ...
    const destination = {
        ...
        errorRoutes: await Promise.all(router
            ...
            url: '',
            headers: {},
        }, {}, route, new RequestContext_1.default()), faultyRoutes))),
