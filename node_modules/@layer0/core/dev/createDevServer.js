...
const bundle_esbuild_1 = __importDefault(require("../deploy/bundle-esbuild"));
/**
...
function createDevServer(options) {
    ...
    const appReady = (options === null || options === void 0 ? void 0 : options.command) ? runLocalApp_1.default(jsPort, options) : Promise.resolve();
    ...
    if (options === null || options === void 0 ? void 0 : options.webpackConfig) {
        ...
        layer0.use(middleware(webpack(options.webpackConfig), {
            writeToDisk: true,
            publicPath: path_1.join(process.cwd(), '.layer0', 's3'),
        }));
    }
    let router;
    const reloadRouter = () => {
        ...
        delete require.cache[paths_1.ROUTER_DESTINATION];
        router = loadRouter_1.default(paths_1.ROUTER_DESTINATION)
    ...
    const routerReady = bundle_esbuild_1.default({
        watch: {
